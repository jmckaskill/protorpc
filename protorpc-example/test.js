(function (proto) {
    ...
    var decoded = proto.decode("com.example.TestMessage", test_proto);
    console.log("test decoder", decoded);
    test_message(decoded);
    console.log("test decoder - finished");

    var encoded = proto.encode("com.example.TestMessage", decoded);
    ...
    var svc = proto.new_client("com.example.Example");
