...
static const struct proto_field fields_FileDescriptorSet[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct FileDescriptorSet, file), 10, &pb_type_FileDescriptorProto, -1}
};
const struct proto_message pb_type_FileDescriptorSet = {
	sizeof(struct FileDescriptorSet),
	sizeof(fields_FileDescriptorSet) / sizeof(struct proto_field),
	fields_FileDescriptorSet
};
...
int pb_print_FileDescriptorProto(pb_buf_t *a, struct FileDescriptorProto const *m) {
	...
	*p++ = '{';
	...
	if (m->public_dependency.len) {
		...
		char *mp = (char*) pb_alloc(a, 3 /*[],*/ + m->public_dependency.len * 12, 1);
		if (!mp) {return -1;}
		*mp++ = '[';
	...
	if (m->weak_dependency.len) {
		...
		char *mp = (char*) pb_alloc(a, 3 /*[],*/ + m->weak_dependency.len * 12, 1);
		if (!mp) {return -1;}
		*mp++ = '[';
...
static const struct proto_field fields_FileDescriptorProto[] = {
	...
	{PROTO_LIST_MESSAGE, offsetof(struct FileDescriptorProto, message_type), 34, &pb_type_DescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct FileDescriptorProto, enum_type), 42, &pb_type_EnumDescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct FileDescriptorProto, service), 50, &pb_type_ServiceDescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct FileDescriptorProto, extension), 58, &pb_type_FieldDescriptorProto, -1},
	{PROTO_MESSAGE, offsetof(struct FileDescriptorProto, options), 66, &pb_type_FileOptions, -1},
	{PROTO_MESSAGE, offsetof(struct FileDescriptorProto, source_code_info), 74, &pb_type_SourceCodeInfo, -1},
	{PROTO_LIST_I32, offsetof(struct FileDescriptorProto, public_dependency), 82, NULL, -1},
	{PROTO_LIST_I32, offsetof(struct FileDescriptorProto, weak_dependency), 90, NULL, -1},
	{PROTO_STRING, offsetof(struct FileDescriptorProto, syntax), 98, NULL, -1}
};
const struct proto_message pb_type_FileDescriptorProto = {
...
char *pb_encode_FileDescriptorProto(char *p, struct FileDescriptorProto const *m) {
	if (m->name.len) {
		p = pb_put_tag_1(p, 10);
		p = pb_put_string(p, *(pb_string_t*)& m->name);
	}
	if (m->package.len) {
		p = pb_put_tag_1(p, 18);
		p = pb_put_string(p, *(pb_string_t*)& m->package);
	}
	if (m->dependency.len) {
		for (int i = 0; i < m->dependency.len; i++) {
			p = pb_put_tag_1(p, 26);
			p = pb_put_string(p, *(pb_string_t*)& m->dependency.v[i]);
		}
	}
	if (m->message_type.len) {
		for (int i = 0; i < m->message_type.len; i++) {
	...
	if (m->syntax.len) {
		p = pb_put_tag_1(p, 98);
		p = pb_put_string(p, *(pb_string_t*)& m->syntax);
	}
	return p;
}
...
static const struct proto_field fields_DescriptorProto[] = {
	...
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, field), 18, &pb_type_FieldDescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, nested_type), 26, &pb_type_DescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, enum_type), 34, &pb_type_EnumDescriptorProto, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, extension_range), 42, &pb_type_DescriptorProto_ExtensionRange, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, extension), 50, &pb_type_FieldDescriptorProto, -1},
	{PROTO_MESSAGE, offsetof(struct DescriptorProto, options), 58, &pb_type_MessageOptions, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct DescriptorProto, oneof_decl), 66, &pb_type_OneofDescriptorProto, -1},
	{PROTO_LIST_POD, offsetof(struct DescriptorProto, reserved_range), 74, &pb_type_DescriptorProto_ReservedRange, -1},
	{PROTO_LIST_STRING, offsetof(struct DescriptorProto, reserved_name), 82, NULL, -1}
};
const struct proto_message pb_type_DescriptorProto = {
...
char *pb_encode_DescriptorProto(char *p, struct DescriptorProto const *m) {
	...
	if (m->reserved_name.len) {
		for (int i = 0; i < m->reserved_name.len; i++) {
			p = pb_put_tag_1(p, 82);
			p = pb_put_string(p, *(pb_string_t*)& m->reserved_name.v[i]);
		}
	}
	return p;
}
...
static const struct proto_field fields_DescriptorProto_ExtensionRange[] = {
	{PROTO_I32, offsetof(struct DescriptorProto_ExtensionRange, start), 8, NULL, -1},
	{PROTO_I32, offsetof(struct DescriptorProto_ExtensionRange, end), 16, NULL, -1},
	{PROTO_MESSAGE, offsetof(struct DescriptorProto_ExtensionRange, options), 26, &pb_type_ExtensionRangeOptions, -1}
};
const struct proto_message pb_type_DescriptorProto_ExtensionRange = {
	sizeof(struct DescriptorProto_ExtensionRange),
	sizeof(fields_DescriptorProto_ExtensionRange) / sizeof(struct proto_field),
	fields_DescriptorProto_ExtensionRange
};
...
static const struct proto_field fields_DescriptorProto_ReservedRange[] = {
	{PROTO_I32, offsetof(struct DescriptorProto_ReservedRange, start), 8, NULL, -1},
	{PROTO_I32, offsetof(struct DescriptorProto_ReservedRange, end), 16, NULL, -1}
};
const struct proto_message pb_type_DescriptorProto_ReservedRange = {
	sizeof(struct DescriptorProto_ReservedRange),
	sizeof(fields_DescriptorProto_ReservedRange) / sizeof(struct proto_field),
	fields_DescriptorProto_ReservedRange
};
...
static const struct proto_field fields_ExtensionRangeOptions[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct ExtensionRangeOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_ExtensionRangeOptions = {
	sizeof(struct ExtensionRangeOptions),
	sizeof(fields_ExtensionRangeOptions) / sizeof(struct proto_field),
	fields_ExtensionRangeOptions
};
...
static const struct proto_field fields_FieldDescriptorProto[] = {
	...
	{PROTO_STRING, offsetof(struct FieldDescriptorProto, extendee), 18, NULL, -1},
	...
	{PROTO_STRING, offsetof(struct FieldDescriptorProto, default_value), 58, NULL, -1},
	{PROTO_MESSAGE, offsetof(struct FieldDescriptorProto, options), 66, &pb_type_FieldOptions, -1},
	{PROTO_I32, offsetof(struct FieldDescriptorProto, oneof_index), 72, NULL, -1},
	{PROTO_STRING, offsetof(struct FieldDescriptorProto, json_name), 82, NULL, -1}
};
const struct proto_message pb_type_FieldDescriptorProto = {
...
char *pb_encode_FieldDescriptorProto(char *p, struct FieldDescriptorProto const *m) {
	...
	if (m->extendee.len) {
		p = pb_put_tag_1(p, 18);
		p = pb_put_string(p, *(pb_string_t*)& m->extendee);
	}
	if (m->number) {
		p = pb_put_tag_1(p, 24);
	...
	if (m->type_name.len) {
		p = pb_put_tag_1(p, 50);
		p = pb_put_string(p, *(pb_string_t*)& m->type_name);
	}
	if (m->default_value.len) {
		p = pb_put_tag_1(p, 58);
		p = pb_put_string(p, *(pb_string_t*)& m->default_value);
	}
	if (m->options) {
		p = pb_put_tag_1(p, 66);
		int szlen = pb_u32_size(m->options->pb_hdr.maxsz);
	...
	if (m->json_name.len) {
		p = pb_put_tag_1(p, 82);
		p = pb_put_string(p, *(pb_string_t*)& m->json_name);
	}
	return p;
}
...
static const struct proto_field fields_OneofDescriptorProto[] = {
	...
	{PROTO_MESSAGE, offsetof(struct OneofDescriptorProto, options), 18, &pb_type_OneofOptions, -1}
};
const struct proto_message pb_type_OneofDescriptorProto = {
...
static const struct proto_field fields_EnumDescriptorProto[] = {
	...
	{PROTO_LIST_MESSAGE, offsetof(struct EnumDescriptorProto, value), 18, &pb_type_EnumValueDescriptorProto, -1},
	{PROTO_MESSAGE, offsetof(struct EnumDescriptorProto, options), 26, &pb_type_EnumOptions, -1},
	{PROTO_LIST_POD, offsetof(struct EnumDescriptorProto, reserved_range), 34, &pb_type_EnumDescriptorProto_EnumReservedRange, -1},
	{PROTO_LIST_STRING, offsetof(struct EnumDescriptorProto, reserved_name), 42, NULL, -1}
};
const struct proto_message pb_type_EnumDescriptorProto = {
...
static const struct proto_field fields_EnumDescriptorProto_EnumReservedRange[] = {
	{PROTO_I32, offsetof(struct EnumDescriptorProto_EnumReservedRange, start), 8, NULL, -1},
	{PROTO_I32, offsetof(struct EnumDescriptorProto_EnumReservedRange, end), 16, NULL, -1}
};
const struct proto_message pb_type_EnumDescriptorProto_EnumReservedRange = {
	sizeof(struct EnumDescriptorProto_EnumReservedRange),
	sizeof(fields_EnumDescriptorProto_EnumReservedRange) / sizeof(struct proto_field),
	fields_EnumDescriptorProto_EnumReservedRange
};
...
static const struct proto_field fields_EnumValueDescriptorProto[] = {
	...
	{PROTO_MESSAGE, offsetof(struct EnumValueDescriptorProto, options), 26, &pb_type_EnumValueOptions, -1}
};
const struct proto_message pb_type_EnumValueDescriptorProto = {
...
static const struct proto_field fields_ServiceDescriptorProto[] = {
	...
	{PROTO_LIST_MESSAGE, offsetof(struct ServiceDescriptorProto, method), 18, &pb_type_MethodDescriptorProto, -1},
	{PROTO_MESSAGE, offsetof(struct ServiceDescriptorProto, options), 26, &pb_type_ServiceOptions, -1}
};
const struct proto_message pb_type_ServiceDescriptorProto = {
...
static const struct proto_field fields_MethodDescriptorProto[] = {
	...
	{PROTO_MESSAGE, offsetof(struct MethodDescriptorProto, options), 34, &pb_type_MethodOptions, -1},
...
const struct proto_message pb_type_MethodDescriptorProto = {
...
char *pb_encode_MethodDescriptorProto(char *p, struct MethodDescriptorProto const *m) {
	...
	if (m->input_type.len) {
		p = pb_put_tag_1(p, 18);
		p = pb_put_string(p, *(pb_string_t*)& m->input_type);
	}
	if (m->output_type.len) {
		p = pb_put_tag_1(p, 26);
		p = pb_put_string(p, *(pb_string_t*)& m->output_type);
	}
	if (m->options) {
		p = pb_put_tag_1(p, 34);
		int szlen = pb_u32_size(m->options->pb_hdr.maxsz);
	...
	if (m->client_streaming) {
		p = pb_put_tag_1(p, 40);
		p = pb_put_bool(p, *(bool*)& m->client_streaming);
	}
	if (m->server_streaming) {
		p = pb_put_tag_1(p, 48);
		p = pb_put_bool(p, *(bool*)& m->server_streaming);
	}
	return p;
}
...
static const struct proto_field fields_FileOptions[] = {
	{PROTO_STRING, offsetof(struct FileOptions, java_package), 10, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, java_outer_classname), 66, NULL, -1},
	{PROTO_ENUM, offsetof(struct FileOptions, optimize_for), 72, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, java_multiple_files), 80, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, go_package), 90, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, cc_generic_services), 128, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, java_generic_services), 136, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, py_generic_services), 144, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, java_generate_equals_and_hash), 160, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, deprecated), 184, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, java_string_check_utf8), 216, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, cc_enable_arenas), 248, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, objc_class_prefix), 290, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, csharp_namespace), 298, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, swift_prefix), 314, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, php_class_prefix), 322, NULL, -1},
	{PROTO_STRING, offsetof(struct FileOptions, php_namespace), 330, NULL, -1},
	{PROTO_BOOL, offsetof(struct FileOptions, php_generic_services), 336, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct FileOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_FileOptions = {
	sizeof(struct FileOptions),
	sizeof(fields_FileOptions) / sizeof(struct proto_field),
	fields_FileOptions
};
char *pb_encode_FileOptions(char *p, struct FileOptions const *m) {
	if (m->java_package.len) {
		p = pb_put_tag_1(p, 10);
		p = pb_put_string(p, *(pb_string_t*)& m->java_package);
	}
	if (m->java_outer_classname.len) {
		p = pb_put_tag_1(p, 66);
		p = pb_put_string(p, *(pb_string_t*)& m->java_outer_classname);
	}
	if (m->optimize_for) {
		p = pb_put_tag_1(p, 72);
	...
	if (m->java_multiple_files) {
		p = pb_put_tag_1(p, 80);
		p = pb_put_bool(p, *(bool*)& m->java_multiple_files);
	}
	if (m->go_package.len) {
		p = pb_put_tag_1(p, 90);
		p = pb_put_string(p, *(pb_string_t*)& m->go_package);
	}
	if (m->cc_generic_services) {
		p = pb_put_tag_2(p, 384);
		p = pb_put_bool(p, *(bool*)& m->cc_generic_services);
	}
	if (m->java_generic_services) {
		p = pb_put_tag_2(p, 392);
		p = pb_put_bool(p, *(bool*)& m->java_generic_services);
	}
	if (m->py_generic_services) {
		p = pb_put_tag_2(p, 400);
		p = pb_put_bool(p, *(bool*)& m->py_generic_services);
	}
	if (m->java_generate_equals_and_hash) {
		p = pb_put_tag_2(p, 416);
		p = pb_put_bool(p, *(bool*)& m->java_generate_equals_and_hash);
	}
	if (m->deprecated) {
		p = pb_put_tag_2(p, 440);
		p = pb_put_bool(p, *(bool*)& m->deprecated);
	}
	if (m->java_string_check_utf8) {
		p = pb_put_tag_2(p, 472);
		p = pb_put_bool(p, *(bool*)& m->java_string_check_utf8);
	}
	if (m->cc_enable_arenas) {
		p = pb_put_tag_2(p, 504);
		p = pb_put_bool(p, *(bool*)& m->cc_enable_arenas);
	}
	if (m->objc_class_prefix.len) {
		p = pb_put_tag_2(p, 674);
		p = pb_put_string(p, *(pb_string_t*)& m->objc_class_prefix);
	}
	if (m->csharp_namespace.len) {
		p = pb_put_tag_2(p, 682);
		p = pb_put_string(p, *(pb_string_t*)& m->csharp_namespace);
	}
	if (m->swift_prefix.len) {
		p = pb_put_tag_2(p, 698);
		p = pb_put_string(p, *(pb_string_t*)& m->swift_prefix);
	}
	if (m->php_class_prefix.len) {
		p = pb_put_tag_2(p, 706);
		p = pb_put_string(p, *(pb_string_t*)& m->php_class_prefix);
	}
	if (m->php_namespace.len) {
		p = pb_put_tag_2(p, 714);
		p = pb_put_string(p, *(pb_string_t*)& m->php_namespace);
	}
	if (m->php_generic_services) {
		p = pb_put_tag_2(p, 720);
		p = pb_put_bool(p, *(bool*)& m->php_generic_services);
	}
	if (m->uninterpreted_option.len) {
		for (int i = 0; i < m->uninterpreted_option.len; i++) {
			p = pb_put_tag_2(p, 16058);
...
static const struct proto_field fields_MessageOptions[] = {
	{PROTO_BOOL, offsetof(struct MessageOptions, message_set_wire_format), 8, NULL, -1},
	{PROTO_BOOL, offsetof(struct MessageOptions, no_standard_descriptor_accessor), 16, NULL, -1},
	{PROTO_BOOL, offsetof(struct MessageOptions, deprecated), 24, NULL, -1},
	{PROTO_BOOL, offsetof(struct MessageOptions, map_entry), 56, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct MessageOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_MessageOptions = {
	sizeof(struct MessageOptions),
	sizeof(fields_MessageOptions) / sizeof(struct proto_field),
	fields_MessageOptions
};
char *pb_encode_MessageOptions(char *p, struct MessageOptions const *m) {
	if (m->message_set_wire_format) {
		p = pb_put_tag_1(p, 8);
		p = pb_put_bool(p, *(bool*)& m->message_set_wire_format);
	}
	if (m->no_standard_descriptor_accessor) {
		p = pb_put_tag_1(p, 16);
		p = pb_put_bool(p, *(bool*)& m->no_standard_descriptor_accessor);
	}
	if (m->deprecated) {
		p = pb_put_tag_1(p, 24);
		p = pb_put_bool(p, *(bool*)& m->deprecated);
	...
	if (m->map_entry) {
		p = pb_put_tag_1(p, 56);
		p = pb_put_bool(p, *(bool*)& m->map_entry);
	}
	if (m->uninterpreted_option.len) {
		for (int i = 0; i < m->uninterpreted_option.len; i++) {
			p = pb_put_tag_2(p, 16058);
...
static const struct proto_field fields_FieldOptions[] = {
	{PROTO_ENUM, offsetof(struct FieldOptions, ctype), 8, NULL, -1},
	{PROTO_BOOL, offsetof(struct FieldOptions, packed), 16, NULL, -1},
	{PROTO_BOOL, offsetof(struct FieldOptions, deprecated), 24, NULL, -1},
	{PROTO_BOOL, offsetof(struct FieldOptions, lazy), 40, NULL, -1},
	{PROTO_ENUM, offsetof(struct FieldOptions, jstype), 48, NULL, -1},
	{PROTO_BOOL, offsetof(struct FieldOptions, weak), 80, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct FieldOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_FieldOptions = {
	sizeof(struct FieldOptions),
	sizeof(fields_FieldOptions) / sizeof(struct proto_field),
	fields_FieldOptions
};
...
static const struct proto_field fields_OneofOptions[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct OneofOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_OneofOptions = {
	sizeof(struct OneofOptions),
	sizeof(fields_OneofOptions) / sizeof(struct proto_field),
	fields_OneofOptions
};
...
static const struct proto_field fields_EnumOptions[] = {
	{PROTO_BOOL, offsetof(struct EnumOptions, allow_alias), 16, NULL, -1},
	{PROTO_BOOL, offsetof(struct EnumOptions, deprecated), 24, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct EnumOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_EnumOptions = {
	sizeof(struct EnumOptions),
	sizeof(fields_EnumOptions) / sizeof(struct proto_field),
	fields_EnumOptions
};
char *pb_encode_EnumOptions(char *p, struct EnumOptions const *m) {
	if (m->allow_alias) {
		p = pb_put_tag_1(p, 16);
		p = pb_put_bool(p, *(bool*)& m->allow_alias);
	}
	if (m->deprecated) {
		p = pb_put_tag_1(p, 24);
		p = pb_put_bool(p, *(bool*)& m->deprecated);
...
static const struct proto_field fields_EnumValueOptions[] = {
	{PROTO_BOOL, offsetof(struct EnumValueOptions, deprecated), 8, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct EnumValueOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_EnumValueOptions = {
	sizeof(struct EnumValueOptions),
	sizeof(fields_EnumValueOptions) / sizeof(struct proto_field),
	fields_EnumValueOptions
};
...
static const struct proto_field fields_ServiceOptions[] = {
	{PROTO_BOOL, offsetof(struct ServiceOptions, deprecated), 264, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct ServiceOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_ServiceOptions = {
	sizeof(struct ServiceOptions),
	sizeof(fields_ServiceOptions) / sizeof(struct proto_field),
	fields_ServiceOptions
};
...
static const struct proto_field fields_MethodOptions[] = {
	{PROTO_BOOL, offsetof(struct MethodOptions, deprecated), 264, NULL, -1},
	{PROTO_ENUM, offsetof(struct MethodOptions, idempotency_level), 272, NULL, -1},
	{PROTO_LIST_MESSAGE, offsetof(struct MethodOptions, uninterpreted_option), 7994, &pb_type_UninterpretedOption, -1}
};
const struct proto_message pb_type_MethodOptions = {
	sizeof(struct MethodOptions),
	sizeof(fields_MethodOptions) / sizeof(struct proto_field),
	fields_MethodOptions
};
...
void pb_term_UninterpretedOption(struct UninterpretedOption *m) {
	...
	if (m->string_value.p) {
		((char*)m->string_value.p)[m->string_value.len] = '\0';
	} else {
		m->string_value.p = (uint8_t*) "";
	}
...
static const struct proto_field fields_UninterpretedOption[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct UninterpretedOption, name), 18, &pb_type_UninterpretedOption_NamePart, -1},
	{PROTO_STRING, offsetof(struct UninterpretedOption, identifier_value), 26, NULL, -1},
	{PROTO_U64, offsetof(struct UninterpretedOption, positive_int_value), 32, NULL, -1},
	{PROTO_I64, offsetof(struct UninterpretedOption, negative_int_value), 40, NULL, -1},
	{PROTO_DOUBLE, offsetof(struct UninterpretedOption, double_value), 49, NULL, -1},
	{PROTO_BYTES, offsetof(struct UninterpretedOption, string_value), 58, NULL, -1},
	{PROTO_STRING, offsetof(struct UninterpretedOption, aggregate_value), 66, NULL, -1}
};
const struct proto_message pb_type_UninterpretedOption = {
	sizeof(struct UninterpretedOption),
	sizeof(fields_UninterpretedOption) / sizeof(struct proto_field),
	fields_UninterpretedOption
};
char *pb_encode_UninterpretedOption(char *p, struct UninterpretedOption const *m) {
	...
	if (m->identifier_value.len) {
		p = pb_put_tag_1(p, 26);
		p = pb_put_string(p, *(pb_string_t*)& m->identifier_value);
	}
	if (m->positive_int_value) {
		p = pb_put_tag_1(p, 32);
		p = pb_put_u64(p, *(uint64_t*)& m->positive_int_value);
	}
	if (m->negative_int_value) {
		p = pb_put_tag_1(p, 40);
	...
	if (m->string_value.len) {
		p = pb_put_tag_1(p, 58);
		p = pb_put_bytes(p, *(pb_bytes_t*)& m->string_value);
	}
	if (m->aggregate_value.len) {
		p = pb_put_tag_1(p, 66);
		p = pb_put_string(p, *(pb_string_t*)& m->aggregate_value);
	}
	return p;
}
...
static const struct proto_field fields_UninterpretedOption_NamePart[] = {
	{PROTO_STRING, offsetof(struct UninterpretedOption_NamePart, name_part), 10, NULL, -1},
	{PROTO_BOOL, offsetof(struct UninterpretedOption_NamePart, is_extension), 16, NULL, -1}
};
const struct proto_message pb_type_UninterpretedOption_NamePart = {
	sizeof(struct UninterpretedOption_NamePart),
	sizeof(fields_UninterpretedOption_NamePart) / sizeof(struct proto_field),
	fields_UninterpretedOption_NamePart
};
char *pb_encode_UninterpretedOption_NamePart(char *p, struct UninterpretedOption_NamePart const *m) {
	if (m->name_part.len) {
		p = pb_put_tag_1(p, 10);
		p = pb_put_string(p, *(pb_string_t*)& m->name_part);
	}
	if (m->is_extension) {
		p = pb_put_tag_1(p, 16);
		p = pb_put_bool(p, *(bool*)& m->is_extension);
	}
	return p;
}
...
static const struct proto_field fields_SourceCodeInfo[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct SourceCodeInfo, location), 10, &pb_type_SourceCodeInfo_Location, -1}
};
const struct proto_message pb_type_SourceCodeInfo = {
	sizeof(struct SourceCodeInfo),
	sizeof(fields_SourceCodeInfo) / sizeof(struct proto_field),
	fields_SourceCodeInfo
};
...
int pb_print_SourceCodeInfo_Location(pb_buf_t *a, struct SourceCodeInfo_Location const *m) {
	...
	*p++ = '{';
	...
	if (m->path.len) {
		...
		char *mp = (char*) pb_alloc(a, 3 /*[],*/ + m->path.len * 12, 1);
		if (!mp) {return -1;}
		*mp++ = '[';
	...
	if (m->span.len) {
		...
		char *mp = (char*) pb_alloc(a, 3 /*[],*/ + m->span.len * 12, 1);
		if (!mp) {return -1;}
		*mp++ = '[';
...
int pb_get_SourceCodeInfo_Location(const char *p, const char *e, pb_buf_t *obj, struct SourceCodeInfo_Location *m) {
	(void) obj;
	if (pb_skipto_1(&p, e, 10)) {
		m->path.v = (int32_t*) obj->next;
		do {
			if (obj->next + m->path.len * sizeof(int32_t) > obj->end) {
				return -1;
			}
			p = pb_get_u32(p + 1, e, (uint32_t*)&m->path.v[m->path.len]);
			m->path.len++;
		} while (!pb_cmp_tag_1(p, e, 10));

		obj->next += m->path.len * sizeof(int32_t);
	}
	if (pb_skipto_1(&p, e, 18)) {
		m->span.v = (int32_t*) obj->next;
		do {
			if (obj->next + m->span.len * sizeof(int32_t) > obj->end) {
				return -1;
			}
			p = pb_get_u32(p + 1, e, (uint32_t*)&m->span.v[m->span.len]);
			m->span.len++;
		} while (!pb_cmp_tag_1(p, e, 18));

		obj->next += m->span.len * sizeof(int32_t);
	}
	if (pb_skipto_1(&p, e, 26)) {
...
static const struct proto_field fields_SourceCodeInfo_Location[] = {
	{PROTO_LIST_I32, offsetof(struct SourceCodeInfo_Location, path), 10, NULL, -1},
	{PROTO_LIST_I32, offsetof(struct SourceCodeInfo_Location, span), 18, NULL, -1},
	{PROTO_STRING, offsetof(struct SourceCodeInfo_Location, leading_comments), 26, NULL, -1},
	{PROTO_STRING, offsetof(struct SourceCodeInfo_Location, trailing_comments), 34, NULL, -1},
	{PROTO_LIST_STRING, offsetof(struct SourceCodeInfo_Location, leading_detached_comments), 50, NULL, -1}
};
const struct proto_message pb_type_SourceCodeInfo_Location = {
	sizeof(struct SourceCodeInfo_Location),
	sizeof(fields_SourceCodeInfo_Location) / sizeof(struct proto_field),
	fields_SourceCodeInfo_Location
};
char *pb_encode_SourceCodeInfo_Location(char *p, struct SourceCodeInfo_Location const *m) {
	if (m->path.len) {
		for (int i = 0; i < m->path.len; i++) {
			p = pb_put_tag_1(p, 10);
			p = pb_put_u32(p, *(uint32_t*)& m->path.v[i]);
		}
	}
	if (m->span.len) {
		for (int i = 0; i < m->span.len; i++) {
			p = pb_put_tag_1(p, 18);
			p = pb_put_u32(p, *(uint32_t*)& m->span.v[i]);
		}
	}
	if (m->leading_comments.len) {
		p = pb_put_tag_1(p, 26);
		p = pb_put_string(p, *(pb_string_t*)& m->leading_comments);
	}
	if (m->trailing_comments.len) {
		p = pb_put_tag_1(p, 34);
		p = pb_put_string(p, *(pb_string_t*)& m->trailing_comments);
	}
	if (m->leading_detached_comments.len) {
		for (int i = 0; i < m->leading_detached_comments.len; i++) {
			p = pb_put_tag_1(p, 50);
			p = pb_put_string(p, *(pb_string_t*)& m->leading_detached_comments.v[i]);
		}
	}
	return p;
}
...
static const struct proto_field fields_GeneratedCodeInfo[] = {
	{PROTO_LIST_MESSAGE, offsetof(struct GeneratedCodeInfo, annotation), 10, &pb_type_GeneratedCodeInfo_Annotation, -1}
};
const struct proto_message pb_type_GeneratedCodeInfo = {
	sizeof(struct GeneratedCodeInfo),
	sizeof(fields_GeneratedCodeInfo) / sizeof(struct proto_field),
	fields_GeneratedCodeInfo
};
...
static const struct proto_field fields_GeneratedCodeInfo_Annotation[] = {
	{PROTO_LIST_I32, offsetof(struct GeneratedCodeInfo_Annotation, path), 10, NULL, -1},
	{PROTO_STRING, offsetof(struct GeneratedCodeInfo_Annotation, source_file), 18, NULL, -1},
	{PROTO_I32, offsetof(struct GeneratedCodeInfo_Annotation, begin), 24, NULL, -1},
	{PROTO_I32, offsetof(struct GeneratedCodeInfo_Annotation, end), 32, NULL, -1}
};
const struct proto_message pb_type_GeneratedCodeInfo_Annotation = {
	sizeof(struct GeneratedCodeInfo_Annotation),
	sizeof(fields_GeneratedCodeInfo_Annotation) / sizeof(struct proto_field),
	fields_GeneratedCodeInfo_Annotation
};
char *pb_encode_GeneratedCodeInfo_Annotation(char *p, struct GeneratedCodeInfo_Annotation const *m) {
	...
	if (m->source_file.len) {
		p = pb_put_tag_1(p, 18);
		p = pb_put_string(p, *(pb_string_t*)& m->source_file);
	}
	if (m->begin) {
		p = pb_put_tag_1(p, 24);
